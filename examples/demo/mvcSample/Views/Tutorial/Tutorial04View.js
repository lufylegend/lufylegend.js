function Tutorial04View(){
	base(this,LView,[]);
}
Tutorial04View.prototype.construct=function(){
};
Tutorial04View.prototype.init=function(){
	var self = this;
...
Tutorial04View.prototype.menuInit=function(){
	var self = this;
 ...
 * 背景
 */
Tutorial04View.prototype.backgroundInit=function(){
	var self = this;
...
Tutorial04View.prototype.buildInit = function(){
...
Tutorial04View.prototype.setBuild=function(path,x,y,name,lv){
	var self = this;
...
Tutorial04View.prototype.addEvent=function(){
	var self = this;
...
Tutorial04View.prototype.onDown=function(event){
	var self = event.clickTarget;
	self.downPoint = {x:event.offsetX,y:event.offsetY,bx:self.backLayer.x,by:self.backLayer.y};
};
Tutorial04View.prototype.onMove=function(event){
	var self = event.clickTarget;
...
Tutorial04View.prototype.onUp=function(event){
	var self = event.clickTarget;
...
Tutorial04View.prototype.cloudsInit=function(){
	var self = this;
...
Tutorial04View.prototype.showBuild = function(buildType){
	var self = this;
	self.die();
 ...
 * 上の顔画像や、ステータス部分
 */
Tutorial04View.prototype.statusInit=function(){
	var self = this;
