function Tutorial06Model(){
	base(this,MyModel,[]);
}
Tutorial06Model.prototype.construct=function(){
	var self = this;
	self.talkIndex = 0;
};
Tutorial06Model.prototype.getImages=function(){console.log("Tutorial06Model.prototype.getImages");
	var list = [
...
Tutorial06Model.prototype.getCloudsPath = function(){
	return "common/domestic_clouds.png";
};
Tutorial06Model.prototype.getBuildList = function(){
	var self = this;
	var buildList = [
...
Tutorial06Model.prototype.toBigmap=function(callback){
	var self = this;
	if(self.local){
	...
	self.post(LMvc.API_PATH+"tutorial/update",{step:7},function(data){
		if(data.result == "yes"){
