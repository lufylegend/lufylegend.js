...
MainModel.prototype.getImages=function(){console.log("Tutorial04Model.prototype.getImages");
	var list = [
...
MainModel.prototype.getCloudsPath = function(){
	return "common/domestic_clouds.png";
};
MainModel.prototype.getBuildList = function(){
	var self = this;
	var buildList = [
